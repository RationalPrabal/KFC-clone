...
import { Box, IconButton, useBreakpointValue,Text,Button } from '@chakra-ui/react';
...
export default function Carousel() {
  ...
  return (
<>
    <Box justifyContent={"space-between"} w='35%'  m={"auto"} display={"flex"} mt="50">
        <Text  mt="1" as='b'>LETS'S ORDER FOR DELIVERY,PICK UP,OR DINE-IN</Text>
        <Button w="25%" borderRadius={"30"} colorScheme={"#e4002d"} bg={"#df0000"}>Start Order</Button>
    </Box>
    <Box
      position={'relative'}
      height={'600px'}
